...
class Theme(models.Model):
    ...
    # Uploadable assets (editable in Django Admin)
    svg_file = models.FileField(
        upload_to="themes/svg/",
        blank=True,
        null=True,
        help_text="SVG pattern file for the theme background",
    )
    preview_image = models.ImageField(
        upload_to="themes/previews/",
        blank=True,
        null=True,
        help_text="Thumbnail/preview image for theme selection",
    )
