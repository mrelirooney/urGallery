...
const nextConfig = {
  ...
  async rewrites() {
    return [
      ...
      { source: "/api/auth/refresh/", destination: `${backendBase}/api/auth/refresh/` },
      { source: "/api/auth/forgot-password", destination: `${backendBase}/api/auth/forgot-password/` },
      { source: "/api/auth/forgot-password/", destination: `${backendBase}/api/auth/forgot-password/` },
      { source: "/api/auth/reset-password", destination: `${backendBase}/api/auth/reset-password/` },
      { source: "/api/auth/reset-password/", destination: `${backendBase}/api/auth/reset-password/` },
      { source: "/api/auth/change-password", destination: `${backendBase}/api/auth/change-password/` },
      { source: "/api/auth/change-password/", destination: `${backendBase}/api/auth/change-password/` },
      { source: "/api/auth/change-email", destination: `${backendBase}/api/auth/change-email/` },
      { source: "/api/auth/change-email/", destination: `${backendBase}/api/auth/change-email/` },
