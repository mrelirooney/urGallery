...
export default function HomePage() {
  ...
  return (
    <main className="w-full flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 px-4 sm:px-6 md:px-8 lg:px-12 min-h-[calc(90dvh-7rem)]">
