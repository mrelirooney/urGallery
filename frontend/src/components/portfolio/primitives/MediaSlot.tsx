...
export default function MediaSlot({src, alt, shape = "1:1", border = true, shadow = true, align = "left"}: MediaSlotProps) {
  const shapeClass =
  ...
  return (
    <div className={`justify-self-center md:justify-self-start overflow-hidden`}>
      <div className={`max-h-[63vh] ${widthClass} ${heightClass} flex items-center justify-center bg-neutral-200 ${borderClass} ${shadowClass}`}>
